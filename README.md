...
Code is split into 2 sections, namely the [ObjC](https://github.com/Cloudilly/Ding-Dong-iBeacons/tree/master/ObjC) and the [NodeJS](https://github.com/Cloudilly/Ding-Dong-iBeacons/tree/master/NodeJS) portion. 
