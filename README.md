...
[Insert your _"App Name"_ and _"Access"_](../../blob/master/ObjC/dingdong/AppDelegate.m#L28-L29). From [Estimote Cloud](https://cloud.estimote.com), obtain also your developer's UUID and Identifer. [Insert the _"UUID"_ and _"Identifer"_](../../blob/master/ObjC/dingdong/AppDelegate.m#L38-L39). Once done, build and run the application on 2 sets of physical devices. Using one of the devices, create a DingDong user account and then pair it with our iBeacon using the earlier _"secret token"_. On the other
